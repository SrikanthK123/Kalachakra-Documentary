...
import { Season3Page } from '@/components/seasons/Season3Page'

export function MainPageContent({ initialSeason = 'S1' }: { initialSeason?: Season }) {
